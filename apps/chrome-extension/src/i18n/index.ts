...
export const translations = {
  zh: {
    ...
    reselect: '重新选择',
    clear: '清除',
    clickElementToSelect: '点击页面上的元素进行选择',
    failedToStartSelection: '启动选择模式失败',
    clickStartToSelect: '点击"开始选择"后，在页面上移动鼠标以高亮元素',
    selectionMode: '选择模式',
    moveMouseToHighlight: '在页面上移动鼠标以高亮元素',
    clickToSelectElement: '点击以选择元素',
    pressEscToCancel: '按 ESC 键取消选择',
    selectedElement: '已选元素',
    semanticDescription: '语义描述',
    position: '位置',
    size: '尺寸',
    suggestedSelectors: '建议的选择器',
    copySelector: '复制选择器',
    ...
    step: '步骤',
    failureReason: '失败原因',
    selectedElementDesc: '已选元素',
    noSuggestions: '无建议',
    tryAnotherElement: '请尝试选择其他元素',
    applied: '已应用',
    confidence: '置信度',
    change: '变更',
    applyRepair: '应用修复',
    applying: '应用中...',
    repairsCompleted: '已完成 {count} 个修复',
    repairApplied: '修复已应用',
    repairFailed: '修复失败',
    failedToGenerateSuggestions: '生成修复建议失败',
  ...
  en: {
    ...
    pressEscToCancel: 'Press ESC to cancel selection',
    ...
    selectedElementDesc: 'Selected Element',
    noSuggestions: 'No Suggestions',
    tryAnotherElement: 'Please try selecting another element',
    applied: 'Applied',
    confidence: 'Confidence',
    change: 'Change',
    applyRepair: 'Apply Repair',
    applying: 'Applying...',
    repairsCompleted: '{count} repair(s) completed',
    repairApplied: 'Repair applied',
    repairFailed: 'Repair failed',
    failedToGenerateSuggestions: 'Failed to generate repair suggestions',
